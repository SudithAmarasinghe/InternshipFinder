...
def hide2():
    openeye2.config(file='close.png')
...
eyeButton1 = Button(frame,image=openeye, bd=0, bg='white', cursor='hand2',command=hide1)
eyeButton1.grid(row=4,column=1)
...
openeye2 = PhotoImage(file='open.png')
eyeButton2 = Button(frame,image=openeye2,bd=0, bg='white',cursor='hand2',command=hide2)
eyeButton2.grid(row=6,column=1)
...
loginButton = Button(frame, text='login', width=10, font=('calibri(body)',10, 'bold'),borderwidth=0, bg='#fff', fg='blue', activeforeground='blue', activebackground='#fff', command=login)
